...
VALUES
    ...
    (3, 'Project Ideas', 'Brainstorm ideas for new project.', 1),
    (4, 'Meeting Agenda', 'Agenda items for the weekly meeting.', 3),
    (5, 'Recipe', 'Ingredients and instructions for lasagna.', 4),
    (6, 'Project Timeline', 'Plan for upcoming project milestones.', 5),
    (7, 'Research Notes', 'Findings from recent research study.', 6),
    (8, 'Travel Itinerary', 'Details for upcoming trip.', 7),
    (9, 'To-Do List', 'Tasks for the week ahead.', 8),
    (10, 'Journal Entry', 'Reflections on the day.', 9);
